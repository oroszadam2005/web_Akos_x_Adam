...
function Open_Close(){
    var offcanvas = document.getElementsByClassName("1")[0];
    if(offcanvas.className =="1 offcanvas show offcanvas-start")
    {
        offcanvas.className ="1 offcanvas offcanvas-start"
    }else{
        offcanvas.className ="1 offcanvas show offcanvas-start"
    }
}
function Open_Close2(){
    var offcanvas = document.getElementsByClassName("2")[0];
    if(offcanvas.className =="2 offcanvas show offcanvas-end")
    {
        offcanvas.className ="2 offcanvas offcanvas-end"
    }else{
        offcanvas.className ="2 offcanvas show offcanvas-end"
    }
}
function canvasGen2()
{
    const target = document.querySelector('#script');
    var board = document.createElement("div");board.id = "hint";
    board.innerHTML = 
    ""+
...
function canvasGen()
{
    ...
    board.innerHTML = 
    ""+
    "<div id='canvasleft' class='1 offcanvas offcanvas-start' tabindex='-1' id='offcanvas' aria-labelledby='offcanvasLabel'>"+
        "<div class='offcanvas-header'>"+
